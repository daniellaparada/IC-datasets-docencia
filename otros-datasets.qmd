...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
ggplotly(
  ggplot(data=viviendas %>% filter(ciudad=="Caballito"),aes(x=sup_cub, y=precioUSD, col=tipo, key=ambientes)) +
    labs(title= "Caballito (viviendas en venta 2013-2018)", x = "Superficie total cubierta (m2)", y = "Precio (USD)") +
    ylim(0, 400) +
    xlim(0, 1000000) +
    geom_point() +
