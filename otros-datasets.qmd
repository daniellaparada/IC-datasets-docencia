...
| [`nombresARG`](#sec-nombresARG) | Estadística descriptiva |
| [`viviendas`](#sec-viviendas)  | Datos espaciales, regresión |
| [`xGFIFA22`](#sec-xGFIFA22)    | Detección de atípicos |
...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
knitr::kable(nombresARG[1:10, ], caption = "Primeros 10 datos de 'nombrarg'.")
```
